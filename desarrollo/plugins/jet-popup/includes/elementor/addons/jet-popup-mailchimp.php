...
class Jet_Popup_Mailchimp extends Jet_Popup_Base {
	...
	protected function render() {
		...
		if ( ! $avaliable_lists ) {
			echo esc_html( $this->empty_lists_message() );
		...
		?><div <?php echo $this->get_render_attribute_string( 'main-container' ); ?>>
			<form method="POST" action="#" class="jet-popup-mailchimp__form">
				<div class="jet-popup-mailchimp__inner">
					<div <?php 
					// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					echo $this->get_render_attribute_string( 'email-field-container' ); ?>><?php
						if ( ! empty( $this->get_settings( 'email_label' ) ) ) {
							?><label <?php 
							// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
							echo $this->get_render_attribute_string( 'email-label' ); ?>><?php
								echo wp_kses_post( $this->get_settings( 'email_label' ) );
							?></label><?php
						}
						?><input <?php 
						// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						echo $this->get_render_attribute_string( 'email-input' ); ?>>
					</div>
			...
			switch ( $type ) {
				...
				case 'address':
					...
					if ( ! empty( $label ) ) {
						...
						<label <?php echo $this->get_render_attribute_string( $label_attr_tag ); ?>><?php echo esc_html( $label ); ?></label><?php
					}?><input 
						<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
						<?php echo $this->get_render_attribute_string( $input_attr_tag ); ?>><?php
				...
				case 'phone':
					...
					if ( ! empty( $label ) ) {
						?><label 
						<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
						<?php echo $this->get_render_attribute_string( $label_attr_tag ); ?>><?php echo esc_html( $label ); ?></label><?php
					}?><input 
						<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
						<?php echo $this->get_render_attribute_string( $input_attr_tag ); ?>><?php
				...
				case 'number':
					...
					if ( ! empty( $label ) ) {
						?><label 
						<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
						<?php echo $this->get_render_attribute_string( $label_attr_tag ); ?>><?php echo $label; ?></label><?php
					}?><input 
						<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
						<?php echo $this->get_render_attribute_string( $input_attr_tag ); ?>><?php
				...
				case 'radio':
					...
					?><fieldset id="<?php echo esc_attr( $id ); ?>" class="jet-popup-mailchimp__field"><?php
						foreach ( $choices as $key => $value ) {
							...
							<div>
								<input 
								<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
								<?php echo $this->get_render_attribute_string( $radio_id ); ?>>
								<label for="<?php echo esc_attr( $radio_id ); ?>"><?php echo esc_html( $value ); ?></label>
							</div>
							<?php
						}?></fieldset><?php
				...
				case 'dropdown':
					...
					if ( ! empty( $label ) ) {
						...
						foreach ( $choices as $key => $value ) {?>
							<option value="<?php echo esc_attr( $value ); ?>"><?php echo esc_html( $value ); ?></option><?php
						}?>
