 ...
 *
 */
if ( ! class_exists( 'ECTCSF_Field_color' ) ) {
  class ECTCSF_Field_color extends ECTCSF_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="ectcsf-color"'. $default_attr . $this->field_attributes() .'/>';
