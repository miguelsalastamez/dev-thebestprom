 ...
 *
 */
if ( ! class_exists( 'ECTCSF_Abstract' ) ) {
  abstract class ECTCSF_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        ECTCSF::$css = apply_filters( "ectcsf_{$this->unique}_output_css", ECTCSF::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'ECTCSF_Field_' . $field_type;
