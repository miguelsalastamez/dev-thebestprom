 ...
 * -----------------------------------------------------------
 *
 * Ectectcsf Framework Gutenberg Block
...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.ectcsf_gutenberg_blocks ) { return; }

  Object.values(window.ectcsf_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'ectcsf-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary ectcsf-shortcode-button',
              onClick: function () {
                window.ectcsf_gutenberg_props = props;
              },
            }, block.button_title ),
