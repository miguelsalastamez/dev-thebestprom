...
* MIT License
*
* Customized by Ectectcsf
*
*/
(function($) {

  function ECTCSFAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  ECTCSFAjaxChosen.prototype.init = function() {
  ...
  ECTCSFAjaxChosen.prototype.events = function() {
  ...
  ECTCSFAjaxChosen.prototype.search_field_focused = function() {
  ...
  ECTCSFAjaxChosen.prototype.search_welcome_message = function() {
  ...
  ECTCSFAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('ectcsf-chosen', _this.options.data).done( function( response ) {
  ...
  ECTCSFAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.ectcsf-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.ECTCSFChosenOrder($hidden_value, true);
  ...
  $.fn.ECTCSFAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new ECTCSFAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, ECTCSFAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  ECTCSFAbstractChosenOrder = (function() {

    function ECTCSFAbstractChosenOrder() {}

    ECTCSFAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    ECTCSFAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    ECTCSFAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    ECTCSFAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    ECTCSFAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    ECTCSFAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    ECTCSFAbstractChosenOrder.ECTCSFChosenOrder = function(select, order, force) {
    ...
    return ECTCSFAbstractChosenOrder;
  ...
  $.fn.extend({
    ECTCSFChosenOrder: function(order, force) {
      return _ECTCSFChosenOrder.ECTCSFChosenOrder(this, order, force);
    }
  });

  this._ECTCSFChosenOrder = (function(_super) {
    __extends(_ECTCSFChosenOrder, _super);

    function _ECTCSFChosenOrder() {
      _ref = _ECTCSFChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _ECTCSFChosenOrder.relAttributeName = 'data-option-array-index';

    _ECTCSFChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _ECTCSFChosenOrder.getDOMElement = function(element) {
    ...
    _ECTCSFChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _ECTCSFChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _ECTCSFChosenOrder;

  })(ECTCSFAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('ectcsf-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('ectcsf-depend-on');
        });
...
(function(root, factory) {
  ...
  //
  // Ectectcsf: Added custom patterns for spesific validate
  //
  var patterns = {
  ...
  //
  // Ectectcsf: Renamed function names for avoid conflicts
  //

  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectECTCSF = FormSerializer.serializeObject;
    $.fn.serializeJSONECTCSF   = FormSerializer.serializeJSON;
  }
