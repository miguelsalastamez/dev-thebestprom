...
use ECTREG\Settings_API as Settings_API;
if (!class_exists('cool_plugins_events_registration_Settings')):
    require_once __DIR__ . '/class.settings-api.php';

    class cool_plugins_events_registration_Settings
{
        ...
        public function add_registration_page()
        {
            ...
            if ($this->settings == null) {
               // $this->settings = \cool_plugins_events_registration_Settings::init();
        ...
        {
            add_submenu_page('cool-plugins-events-addon','Cool Plugins Product Registration', 'License', 'manage_options', 'cool-events-registration', array($this, 'show_Page'), 10 );
        }
