 ...
 *   ect_pro_create_admin_notice( array('id'=>'bp-greeting-mesage','message'=>'Hey there!') );
 * 
 *              create a admin text error message
 * ect_pro_create_admin_notice( array('id'=>'bp-error-mesage','message'=>'this is an example of error!','type'=>'error') );
...
if (!class_exists('ect_admin_notices')):
    ...
    final class ect_admin_notices
    {
        ...
        private function ect_admin_notice_for_review( $id, $messageObj ){
            ...
            if(get_option( 'ect-installDate' )){
                // get installation dates and rated settings
                //$installation_date =date( 'Y-m-d h:i:s', get_option( 'ect-installDate' ));
                $installation_date =date( 'Y-m-d h:i:s', strtotime(get_option( 'ect-installDate' )) );
            }else{
                $this->ect_show_error('Review notice can not be integrated. ect-installDate option is not set for the plugin');
                return;
            }
     ...
     ********************************************************************************/
    function ect_pro_create_admin_notice($notice)
    {
