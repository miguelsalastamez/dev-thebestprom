...
* Tweak - Added EDD as a provider to use with Community Tickets. [CT-84]
...
* Tweak - Make use of new sales report hook `tec_tickets_commerce_order_report_after_sales_breakdown` to display event fees. [ET-1810]
