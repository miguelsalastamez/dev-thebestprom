...
class IGDGoogle_Http_Request {
	...
	public function disableGzip() {
		...
		$this->canGzip   = false;
		$this->userAgent = str_replace( self::GZIP_UA, "", $this->getUserAgent() ?? "" );
	}
	...
	public function getUserAgent() {
		return empty( $this->userAgent ) ? IGDGoogle_Client::USER_AGENT_SUFFIX . IGDGoogle_Client::LIBVER : $this->userAgent;
	}
