...
wp_enqueue_style( 'cool-plugins-events-addon-latest-db', EPTA_PLUGIN_URL . 'admin/events-addon-page/assets/css/styles.min.css', array(), EPTA_PLUGIN_CURRENT_VERSION, 'all' );
