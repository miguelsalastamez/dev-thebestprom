 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'ECTCSF_Fields' ) ) {
	abstract class ECTCSF_Fields extends ECTCSF_Abstract {
		...
		public function field_before() {
			...
			return ( ! empty( $this->field['before'] ) ) ? '<div class="ectcsf-before-text">' . $this->field['before'] . '</div>' : '';
		}

		public function field_after() {

			$output  = ( ! empty( $this->field['after'] ) ) ? '<div class="ectcsf-after-text">' . $this->field['after'] . '</div>' : '';
			$output .= ( ! empty( $this->field['desc'] ) ) ? '<div class="clear"></div><div class="ectcsf-desc-text">' . $this->field['desc'] . '</div>' : '';
			$output .= ( ! empty( $this->field['help'] ) ) ? '<div class="ectcsf-help"><span class="ectcsf-help-text">' . $this->field['help'] . '</span><i class="fas fa-question-circle"></i></div>' : '';
			$output .= ( ! empty( $this->field['_error'] ) ) ? '<div class="ectcsf-error-text">' . $this->field['_error'] . '</div>' : '';
