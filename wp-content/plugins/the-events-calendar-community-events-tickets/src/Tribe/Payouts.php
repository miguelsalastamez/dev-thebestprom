...
class Payouts {
	...
	public function register_post_type() {
		$payout_post_args = [
			'label'           => 'Payouts',
			'labels'          => [
				'name'          => __( 'Payouts', 'tribe-events-community-tickets' ),
				'singular_name' => __( 'Payout', 'tribe-events-community-tickets' ),
			],
	...
	protected function build_post_stati() {
		$stati = [
			self::STATUS_PENDING_ORDER    => [
				'label'                     => __( 'Pending Order Completion', 'tribe-events-community-tickets' ),
				'public'                    => false,
				'exclude_from_search'       => false,
				'show_in_admin_all_list'    => true,
				'show_in_admin_status_list' => true,
				/* translators: %s: number of payouts */
				'label_count'               => _n_noop( 'Pending Order Completion <span class="count">(%s)</span>', 'Pending Order Completion <span class="count">(%s)</span>', 'tribe-events-community-tickets' ),
			],
			self::STATUS_PENDING          => [
				'label'                     => __( 'Pending Payout', 'tribe-events-community-tickets' ),
				'public'                    => false,
				'exclude_from_search'       => false,
				'show_in_admin_all_list'    => true,
				'show_in_admin_status_list' => true,
				/* translators: %s: number of payouts */
				'label_count'               => _n_noop( 'Pending Payout <span class="count">(%s)</span>', 'Pending Payout <span class="count">(%s)</span>', 'tribe-events-community-tickets' ),
			],
			self::STATUS_PAID             => [
				'label'                     => __( 'Paid', 'tribe-events-community-tickets' ),
				'public'                    => false,
				'exclude_from_search'       => false,
				'show_in_admin_all_list'    => true,
				'show_in_admin_status_list' => true,
				/* translators: %s: number of payouts */
				'label_count'               => _n_noop( 'Paid <span class="count">(%s)</span>', 'Paid <span class="count">(%s)</span>', 'tribe-events-community-tickets' ),
			],
			self::STATUS_FAILED           => [
				'label'                     => __( 'Failed', 'tribe-events-community-tickets' ),
				'public'                    => false,
				'exclude_from_search'       => false,
				'show_in_admin_all_list'    => true,
				'show_in_admin_status_list' => true,
				/* translators: %s: number of payouts */
				'label_count'               => _n_noop( 'Failed <span class="count">(%s)</span>', 'Failed <span class="count">(%s)</span>', 'tribe-events-community-tickets' ),
			],
		];
	...
	public function should_show_payouts_actions( $post ) {
		...
		// Only if the post was created via Community Events.
