<?php
/**
 * Photography for WooCommerce Admin.
 *
 * @since 1.2.0
 */
...
class Admin {
	...
	public static function action_links( $links ) {
		$settings_link = sprintf(
			...
			_x( 'View Photography for WooCommerce settings', 'aria-label: settings link', 'woocommerce-photography' ),
	...
	public static function plugin_row_meta( $links, $file ) {
		...
		$links['docs'] = sprintf(
			...
			esc_attr_x( 'View Photography for WooCommerce documentation', 'aria-label: documentation link', 'woocommerce-photography' ),
