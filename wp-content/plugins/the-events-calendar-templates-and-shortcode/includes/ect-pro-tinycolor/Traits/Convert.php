...
trait Convert
{
    ...
    {
        return [
            'r' => EctProbound01($r, 255) * 255,
            'g' => EctProbound01($g, 255) * 255,
            'b' => EctProbound01($b, 255) * 255,
        ];
    }
    ...
    protected function rgbToHsl($r, $g, $b)
    {
        ...
        $r = EctProbound01($r, 255);
        $g = EctProbound01($g, 255);
        $b = EctProbound01($b, 255);
    ...
    protected function hslToRgb($h, $s, $l)
    {
        ...
        $h = EctProbound01($h, 360);
        $s = EctProbound01($s, 100);
        $l = EctProbound01($l, 100);
    ...
    protected function hsvToRgb($h, $s, $v)
    {
        ...
        $h = EctProbound01($h, 360) * 6;
        $s = EctProbound01($s, 100);
        $v = EctProbound01($v, 100);
    ...
    {
        $hex = [
            EctPropad2(dechex(round($r))),
            EctPropad2(dechex(round($g))),
            EctPropad2(dechex(round($b))),
        ];
    ...
    protected function rgbaToHex($r, $g, $b, $a, $allow4Char = false)
    {
        ...
        $hex = [
            ...
            EctPropad2(dechex(round($g))),
            EctPropad2(dechex(round($b))),
            EctPropad2(EctProconvertDecimalToHex($a)),
        ];
