...
function tbp_asientos_render_edit_view( $config_id = 0 ) {
    ...
    <div id="tbp-stage-3" class="tbp-stage-content" style="display:none;">
        <div class="postbox">
            <div class="postbox-header"><h2 class="hndle">Etapa 3: Generación del Listado y Asignación Final</h2></div>
            <div class="inside">
                <p>Usa esta etapa para confirmar la asignación automática basada en el plano generado en la Etapa 2.</p>
                <?php if ( $config_id > 0 ) : ?>
                    <div style="display:grid; grid-template-columns: 1fr 1fr; gap:20px;">
                        <div style="background:#f8fafc; padding:20px; border-radius:8px; border:1px solid #e2e8f0;">
                            <h3 style="margin-top:0;">🤖 Asignación Automática</h3>
                            <p>El sistema tomará los grupos del listado y los acomodará en las mesas disponibles del plano.</p>
                            <button type="button" id="btn_run_packing_v2" class="button button-primary button-large">Ejecutar Asignación Inteligente</button>
                        </div>
                        <div style="background:#f8fafc; padding:20px; border-radius:8px; border:1px solid #e2e8f0;">
                            <h3 style="margin-top:0;">👀 Revisión Manual</h3>
                            <p>Ver el resultado de la asignación y realizar ajustes finos mediante Drag & Drop.</p>
