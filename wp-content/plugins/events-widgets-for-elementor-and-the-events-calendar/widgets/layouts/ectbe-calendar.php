...
$ectbe_calendar_html = '';
$ectbe_calendar_html .= '<div class="ectbe-calendar-wrapper">';
$ectbe_calendar_html .= '<div class="ectbe_calendar_events_spinner"><img src="'.esc_url( ECTBE_URL ) .'assets/images/ectbe-preloader.gif"></div>';
	 
$ectbe_calendar_html .= '<div id="ectbe-event-calendar-'.esc_attr( $this->get_id() ).'" class="ectbe-event-calendar-cls"
    ...
    $ectbe_calendar_html .= '</div>';


    $ectbe_calendar_html .=  '<div id="ectbe-popup-wraper" class="ectbe-modal ectbe-zoom-in">
            ...
            <div class="ectbe-modal-content">
                ...
                if($details_link!='yes'){
                    $ectbe_calendar_html .='<div class="ectbe-modal-footer">
                        <a class="ectbe-event-details-link"><button>'.esc_html__("Read More",'events-widgets-for-elementor-and-the-events-calendar').'</button></a>
                    </div>';
                }
...
echo wp_kses_post($ectbe_calendar_html);